(function () {
    ...
    function buildComponentTree(value) {
        ...
        cy.on('tap', 'node', function (evt) {
            renderComponents([...evt.target.data('word')], container, false);
        });
    }
    ...
    function renderData(characters, skipState) {
    ...
    function parseUrl(path) {
        ...
        //allow new components at the end of the URL to maintain backwards compatibility
        //expectation is: /components/<search_term>
        //and maybe someday: /components/<search_term>/<language>
